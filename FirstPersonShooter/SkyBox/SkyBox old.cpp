...
void SkyBox::Initialize()
{
	//float high = -90;
	// bottom - floor
	walls[0]->VertexData.push_back(vec3(Unitsize, -0, Unitsize));
	walls[0]->VertexData.push_back(vec3(-Unitsize, -0, Unitsize));
	walls[0]->VertexData.push_back(vec3( -Unitsize,-0 , -Unitsize));
	walls[0]->VertexData.push_back(vec3( Unitsize, -0, -Unitsize));
